...
import signal
import subprocess
from util import ardupilot_path, ardusub_path, config_parser, gazebo_path
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='''Run the GUI with Gazebo Simulation. The config file be a JSON file with 3 fields.
            ...
            headless: A boolean. If true, gazebo will run without the GUI. If false, gazebo will run with the GUI.
